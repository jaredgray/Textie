...
namespace Kbg.NppPluginNET.PluginInfrastructure
{
    public class Win32
    {
        ...
        public class Win32Keyboard
        {
            ...
            [DllImport("user32.dll")]
            public static extern short GetAsyncKeyState2(Keys vKey); // for applications that are not driving the message pump
            [DllImport("user32.dll")]
...
0x5A	Z key
        ...
        //{
        //    _hookID = SetKeyboardHookHook(_proc);
        //    Application.Run();
        //    UnhookWindowsHookEx(_hookID);
        //}

        public static IntPtr SetKeyboardHookHook(LowLevelKeyboardProc proc)
        {
